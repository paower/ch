<template>
	<view class="center">
		<cu-custom bgColor="bg-gradual-blue" :isBack="true">
			...
			<block slot="content">修改安全密码</block>
		</cu-custom>
	<view class="container999">
		<view class="title">不定期修改密码可以提升账户安全！</view>
		<view class='line'>
		  <view class="lineRight">  
			<input class="input" placeholder-class="plaClass" placeholder='请输入原安全密码' v-model="old_password"></input>
			</view>
		</view>
		<view class='line'>
		  <view class="lineRight">  
			<input class="input" placeholder-class="plaClass" placeholder='请输入新的安全密码' v-model="new_password"></input>
			</view>
		</view>
	...
	export default {
		...
		methods:{
			submit:function(){
				...
				api.post({
					url:'Api/PassApi/EditSafetyPassword',
