...
/*echo $oid;die;*/
		...
		foreach ($order as $k => $v) {
			//订单验证
			$order[$k]['buy_price'] = number_format($v['buy_price']/$sell_new_price,2);
	...
	public function pays()
	{
		...
		$pay_money = number_format($pay_money/$sell_new_price,2);
